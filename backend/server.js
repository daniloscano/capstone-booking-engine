...
const authRoute = require('@authModules/auth.route')
...
server.use("/room-types", roomTypeRoute)
server.use("/room-beds", roomBedRoute)
server.use("/room-units", roomUnitRoute)
server.use("/room-rates", roomRateRoute)
server.use("/room-amenities", roomAmenityRoute)
...
server.use("/booking-policies", bookingPolicyRoute)
server.use("/bookings", bookingRoute)
server.use("/booking-payments", bookingPaymentRoute)
server.use("/quote-requests", quoteRequestRoute)
server.use("/quote-solutions", quoteSolutionRoute)
